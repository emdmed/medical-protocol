...
> Binding constraints for all workflows that create or modify components in `medprotocol-ui` (`/home/enrique/projects/medprotocol-ui`).
> Components live in a separate repo from this one — never create `.tsx` files in medprotocol-core.
