...
3. **Classification row in `context/classification.md`** — Add a row to the domain classification table with signal words that route doctors to the new workflow
