/**
 * CLI-safe temperature functions — self-contained, no lucide-react dependency.
 * Logic mirrors temperature-validations.tsx but without icon/color fields.
 */
...
export const validateTemperatureInput = (
  ...
  const limits = useFahrenheit
    ? TEMPERATURE_LIMITS.FAHRENHEIT
    : TEMPERATURE_LIMITS.CELSIUS;
