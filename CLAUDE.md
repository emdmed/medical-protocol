...
|------|-------------|----------------|
| **1. Workflows & Plugin** (this repo) | Markdown protocols, workflows, context, skills, and hooks that agents like Claude Code consume. Installed via `npx medical-protocol install`. Also contains `lib/` with pure calculation logic and `packages/medprotocol/` CLI. | `/home/enrique/projects/medprotocol-core` |
...
public/medical-protocol/context/   # Shared medical context (13 files)
...
- **Shared context:** 13 files in `public/medical-protocol/context/` — component registry, classification, CLI ref, composition patterns, and 9 per-module docs (single source of truth)
- **Version:** 0.7.3 (synced across package.json, provider manifest, medprotocol/package.json, medical-protocol/package.json)
