...
See `protocol.md` (Communication Rules, Interface Language sections) for the full reference. These rules are loaded via the protocol and should not be duplicated here.
