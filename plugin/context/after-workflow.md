...
4. **Run Browser QA** (quality-checklist.md item 5) — only if agent-browser is installed and the server is ready. Follow `providers/claude-code/workflows/agent-qa.md`. Fix any issues automatically.
