...
1. **Run static quality checks** (quality-checklist.md items 1–4) — automatically review and fix any issues. Read and follow `${CLAUDE_PLUGIN_ROOT}/context/quality-checklist.md`.
...
4. **Run Browser QA** (quality-checklist.md item 5) — only if agent-browser is installed and the server is ready. Follow `${CLAUDE_PLUGIN_ROOT}/reference/workflows/agent-qa.md`. Fix any issues automatically.
