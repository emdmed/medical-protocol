...
describe("calculateASCVD", () => {
  ...
  // Reference case: 55yo white male, TC 213, HDL 50, SBP 120, no treatment/DM/smoking
  // AHA calculator gives ~5-6%
  ...
  // High-risk case: 65yo AA female, TC 250, HDL 40, SBP 160, treated, diabetic, smoker
...
describe("getCHADSVAScCategory", () => {
  ...
  // Female thresholds: sex alone = 1 point, so threshold shifts up
