...
// BMI functions are not exported from the component, so we replicate them
// exactly as defined in bmi-calculator.tsx for testing the clinical logic.
const calculateBMI = (
  w: string,
  hFt: string,
  hIn: string,
...
describe('calculateBMI — imperial', () => {
  it('calculates BMI for 154 lbs, 5\'9"', () => {
    // (154 / (69^2)) * 703 = (154/4761)*703 = 22.7
  ...
  it('calculates BMI for 200 lbs, 5\'10"', () => {
    // (200 / 70^2) * 703 = (200/4900)*703 = 28.7
